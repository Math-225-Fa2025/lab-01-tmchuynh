...
In order to do this we will make use of faceting.

```{r all-viz, eval=FALSE, fig.fullwidth=TRUE, fig.height=12, fig.width=10}
...
```{r theme-highlight, echo=FALSE, fig.margin=TRUE}
...
> Not sure how to use emojis on your computer?
